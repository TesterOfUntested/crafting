...
export default function Projects() {
  ...
  <div className="projects-grid">
        ...
        <div className="project-card">
          <FirebaseImage
            path="photo_coffee.jpeg"
            alt="Sweter Zimowy poranek"
            className="project-img"
            fallbackSrc="./photos/photo_coffee.jpeg"
          />
        ...
        <div className="project-card">
          <FirebaseImage
            path="photo_layer.jpeg"
            alt="Kardigan Jesienny liść"
            className="project-img"
            fallbackSrc="./photos/photo_layer.jpeg"
          />
        ...
        <div className="project-card">
          <FirebaseImage
            path="photo_phone.jpeg"
            alt="Chusta Letni wiatr"
            className="project-img"
            fallbackSrc="./photos/photo_phone.jpeg"
          />
